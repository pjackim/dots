...
change_color() {
	# polybar
	sed -i -e 's/background = #.*/background = #F0EFE7/g' $PFILE
	sed -i -e 's/foreground = #.*/foreground = #FFFFFF/g' $PFILE
	sed -i -e 's/foreground-alt = #.*/foreground-alt = #2e8792/g' $PFILE
...
if  [[ $1 = "--amber" ]]; then
	SH1="#535C46"	SH2="#636B4E"	SH3="#727A57"	SH4="#82885F"
	SH5="#919767"	SH6="#A5A981"	SH7="#B9BB9B"	SH8="#CDCDB4"
	change_color
elif  [[ $1 = "--blue" ]]; then
